...
const Dashboard = memo(function Dashboard() {
  ...
  return (
    <PageTransition className="space-y-4 pb-12" style={{ minHeight: "100%", background: "#000000" }} fill={false}>
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 478 501" width={18} height={18} style={{ color: "rgba(255,255,255,0.6)" }}>
        ...
        <span className="text-[13px] font-semibold text-white/60">Alerts</span>
      </motion.button>
